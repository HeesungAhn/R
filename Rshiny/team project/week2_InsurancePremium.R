...
This is a code for R shiny application calculating non-life insurance premium through GLM.

Input: deductible, limit, prior-distribution(Pareto, Frechet, log-normal)
Output: insurance premium, parameter
...
sidebar <- dashboardSidebar(
  ...
  sidebarMenu(id="type",
              menuItem("Accident Insurance", tabName = "acc"),
              menuItem("Fire Insurance", tabName = "fire"))
...
## function
data1 <- read.csv("./accident_insurance3.csv")
data2 <- read.csv("./fire_insurance3.csv")
